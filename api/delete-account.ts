...
import { captureServer } from "./_sentry";
...
export default async function handler(request: VercelRequest, response: VercelResponse) {
  ...
  try {
    ...
    // garante consistencia caso o cascade falhe ou o schema mude. Inclui as
    // tabelas de billing (subscriptions, usage_log) — antes so caiam por cascade.
    ...
    void captureServer(error, { tag: "api/delete-account" });
